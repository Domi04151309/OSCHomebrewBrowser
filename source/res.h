...
#define TEXT_COLOUR_PRIMARY 0x212121FF
#define TEXT_COLOUR_PRIMARY_DARK 0xDEDEDEFF
#define TEXT_COLOUR_SECONDARY 0x666666FF
#define TEXT_COLOUR_SECONDARY_DARK 0x999999FF
